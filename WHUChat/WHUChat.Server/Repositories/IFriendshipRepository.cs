...
namespace WHUChat.Server.Repositories
{
    public interface IFriendshipRepository
    {
        ...
        Task<FriendRelation?> GetFriendRelationAsync(long userId, long friendId); 
        void DeleteFriendRelation(FriendRelation relation);
        Task DeleteFriendRelationsAsync(long userId, long friendId); 
